const resources = [
  ...
  },
  {
    ...
    items: [
      { title: "freeCodeCamp", url: "https://www.freecodecamp.org/", note: "Cursos interactivos gratuitos para aprender a programar." },
      { title: "JavaScript.info", url: "https://javascript.info/", note: "Tutorial moderno y detallado de JS." },
      { title: "CSS-Tricks", url: "https://css-tricks.com/", note: "Artículos, trucos y guías completas de CSS." },
      { title: "Web.dev", url: "https://web.dev/", note: "Guías creadas por Google para construir webs modernas." },
      { title: "Frontend Masters", url: "https://frontendmasters.com/", note: "Cursos en vídeo de nivel profesional." }
    ]
  },
  {
    category: "Herramientas",
    items: [
      { title: "VS Code", url: "https://code.visualstudio.com/", note: "El editor de código más popular." },
      { title: "GitHub", url: "https://github.com/", note: "Alojamiento de repositorios Git." },
      { title: "CodePen", url: "https://codepen.io/", note: "Entorno de desarrollo social para front-end." },
      { title: "Figma", url: "https://www.figma.com/", note: "Herramienta líder de diseño colaborativo." },
      { title: "Netlify", url: "https://www.netlify.com/", note: "Plataforma de hosting e integración continua." }
    ]
  },
  {
